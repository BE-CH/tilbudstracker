    ...
    <SafeAreaView style={styles.safeArea}>
      <View>
        ...
        <Text style={styles.aboutText}>
          ...
          tilbudsaviser og derudover kan det være svært at vurdere om et tilbud
          rent faktisk er et godt tilbud.
        </Text>
        <Text style={styles.aboutText}>
          Ovenstående problemer prøver tilbudstracker at løse ved at levere en
          overskuelig, søgbar og nem måde at se ugens tilbud på!
        </Text>
        <Text style={styles.aboutText}>
        ...
        <View style={styles.aboutView}>
          <Text style={styles.whoText}>
            ...
            <Text onPress={() => Linking.openURL('https://tilbudstracker.dk')}>
              tilbudstracker.dk
            </Text>{' '}
            er udviklet i sjov af{' '}
            <Text onPress={() => Linking.openURL('https://bechsolutions.dk')}>
